/**
 * @failure External-store subscriptions and Silvery input subscriptions race,
...
//
// 1. Zustand is not a Silvery dependency. Adding it solely for this
//    narrow seam test would expand the package's installation surface.
