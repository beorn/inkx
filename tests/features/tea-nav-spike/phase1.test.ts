/**
 * @failure A pure navigation reducer cannot cross Silvery's apply/effect seam,
 ...
 * comfortably wrap a pure km-style navigation reducer, or does the
 * signature flip force shoehorning?" KM's separate reducer suite pins the
 * state/effect behavior mirrored by this local fixture.
 *
