...
- Effort: 1-2 hours
11. **Component docs potentially thin (49 pages at ~300-500 words)**
...
16. **No SoftwareApplication schema on homepage**
...
- Effort: 30 minutes
21. **No FAQPage schema on comparison pages**
...
- Effort: 1-2 hours
26. **No terminal screenshots or visual proof**
...
15. **No HowTo schema on getting-started pages**
- Could show step-by-step rich results
- Effort: 30 minutes
19. **No external authority signals on site**
- Add npm download badge, GitHub stars, contributor count
- Effort: 1 hour
23. **Theme Explorer JS-rendered content**
