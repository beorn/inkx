# Co-founder / M&A candidates

**Status**: confidential. Not for external sharing. Maintained as the portfolio matures and conversations happen.

**Purpose**: track named candidates for first-hire / co-founder / M&A bring-in, alongside the rationale for each. Per the strategy brainstorm Phase 4 — *"first hire / co-founder candidates: cloud-ops backgrounds (multi-cloud, IaC, multi-tenant infra) — specific candidates tracked confidentially."*
...
- **Status**: <prospect / contacted / in conversation / committed / passed>
- **What they do**: <one line>
- **Why a fit**: <which gap they fill — services ops, AI/ML, sales, design, etc.>
- **Founder relationship**: <how the introduction would happen>
- **Possible structures**: <acqui-hire / co-founder / partnership / advisory>
- **Risks**: <alignment, cap table, scope drift, etc.>
- **Action**: <next step + when>
```
