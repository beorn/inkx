...
Effects are data — plain objects returned from `update`. The kernel runs them. Silvery provides combinators for common async patterns:

```tsx
import { none, batch, dispatch, debounce, throttle } from "@silvery/ag-term/core"
