...
For technical explanations of these optimizations, see [Performance Deep Dive](performance.md). For the head-to-head Ink comparison with context and code examples, see [Silvery vs Ink](../../silvery/docs/guide/silvery-vs-ink.md).
