...
- **Silvery**: Would ship faster. `CommandPalette`, `SelectList`, `TextInput`, `ModalDialog`, `Tabs`, `TextArea`, `Spinner`, `Toast`, `Link` are all built-in. Semantic theme tokens + 84 color schemes remove theme-plumbing entirely.
