...
const LANG_KEYWORDS: Record<string, string[]> = {
  ts: ["const", "let", "var", "function", "async", "await", "return", "if", "else", "export", "import", "from", "as", "type", "interface", "class", "extends", "implements", "new", "for", "while", "do", "break", "continue", "switch", "case", "default", "try", "catch", "finally", "throw", "this", "super", "null", "undefined", "true", "false", "void"],
  tsx: ["const", "let", "var", "function", "async", "await", "return", "if", "else", "export", "import", "from", "as", "type", "interface", "class", "extends", "new"],
  js: ["const", "let", "var", "function", "async", "await", "return", "if", "else", "export", "import", "from", "as", "class", "extends", "new"],
  py: ["def", "class", "return", "if", "elif", "else", "for", "while", "import", "from", "as", "pass", "break", "continue", "lambda", "with", "yield", "raise", "try", "except", "finally", "True", "False", "None", "self"],
  rs: ["fn", "let", "mut", "const", "pub", "use", "mod", "struct", "enum", "impl", "trait", "match", "if", "else", "for", "while", "return", "self", "Self", "async", "await", "move", "crate", "ref"],
  go: ["func", "var", "const", "package", "import", "type", "struct", "interface", "return", "if", "else", "for", "range", "switch", "case", "default", "go", "chan", "map"],
  sh: ["if", "fi", "then", "else", "elif", "for", "while", "do", "done", "function", "return", "export", "local", "case", "esac", "in"],
  bash: ["if", "fi", "then", "else", "elif", "for", "while", "do", "done", "function", "return", "export", "local", "case", "esac", "in"],
  sql: ["SELECT", "FROM", "WHERE", "INSERT", "INTO", "UPDATE", "DELETE", "CREATE", "TABLE", "INDEX", "DROP", "ALTER", "JOIN", "LEFT", "RIGHT", "INNER", "OUTER", "ON", "AS", "GROUP", "BY", "ORDER", "LIMIT", "OFFSET", "HAVING"],
  json: [],
  md: [],
  yaml: [],
  plain: [],
