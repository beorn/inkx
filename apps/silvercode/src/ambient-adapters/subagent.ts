 ...
 *
 * Per `ambient-context-safety.md` § 3, every payload passes through Layer
 * 2 (`sanitizeAmbient`) — the `createDebouncedEmit` helper enforces that.
 *
 * Coordination value: peer sessions watching ambient events see "session
 ...
 *
 * Tracking: `km-silvercode.ambient-subagent-real`.
 */
