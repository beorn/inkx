 ...
 * ambient adapter and prints the resulting digest event.
 *
 ...
 *
 *   bun apps/silvercode/tests/ambient-adapters/recall-smoke.ts <query>
 *
...
import { triggerRecallProbe } from "../../src/ambient-adapters/recall.ts"
