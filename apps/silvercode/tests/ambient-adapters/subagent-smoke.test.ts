 ...
 * real ambient events all the way through sanitize → debounce → enqueue.
 *
...
import { registerSubagentAmbientAdapterHandle } from "../../src/ambient-adapters/subagent.ts"

describe("ambient-adapter/subagent — smoke (synthetic Task lifecycle)", () => {
