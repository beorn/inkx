 ...
 * - ink: Original Ink library (default, most stable)
 * - inkx: Custom fork with double-buffering
 * - inkx-flexx: Custom fork with pure JS flexbox layout
 */
export type TuiEngine = "ink" | "inkx" | "inkx-flexx";
