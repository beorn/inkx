 ...
 * - Cmd+click → navigate/zoom into the card (metaKey from keyboard modifier tracking)
...
export function useCardInteraction(nodeId: string, isSelected: boolean): CardInteraction {
  ...
  const handleClick = useCallback(
    (e: SilveryMouseEvent) => {
      ...
      // e.metaKey is accurate — silvery merges Kitty keyboard modifier state into mouse events
