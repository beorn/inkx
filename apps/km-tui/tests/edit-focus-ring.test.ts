 ...
 *
 * When inline editing a card (pressing Enter), the card border turns cyan.
 * No background fill — the cyan border + inverse cursor indicate editing.
 * Non-active body blocks show cyan text to signal they're part of
 * the editable area.
 */
