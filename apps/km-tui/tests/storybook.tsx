...
// Helper to create mock ColumnSnapshot
function mockColumn(name: string, cardNodes: KNode[]): ColumnSnapshot {
  return {
...
function createMockTUIBoardState(): TUIBoardState {
  ...
  // These tasks have embed_of set, pointing to ORIGINAL tasks in other files
