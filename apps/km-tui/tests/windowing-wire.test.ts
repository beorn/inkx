...
/** $bg-selected resolved against the active test theme (Nord-derived).
...
const SELECTION_BG = TC["$bg-selected"]
/** Back-compat alias — detail pane used to use $bg-cursor; now uses $bg-selected.
