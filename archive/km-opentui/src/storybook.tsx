...
function createMockViewModel(): TreeViewModel {
  ...
  const nodes: NodeViewModel[] = [
    ...
    node("col2", "In Progress", [
      node("wip1", "Implement auth", [], {
        taskStatus: "wip",
        priority: 1,
        childCount: 3,
        depth: 1,
      }),
      node("wip2", "Fix bug #42", [], {
        taskStatus: "wip",
        dueDate: "2025-01-18",
        depth: 1,
      }),
      node("wip3", "Refactor DB layer", [], {
        taskStatus: "wip",
        childCount: 1,
        depth: 1,
      }),
    ...
    node("col3", "Blocked", [
      node("blk1", "Deploy to staging", [], {
        taskStatus: "blocked",
        childCount: 1,
        depth: 1,
      }),
      node("blk2", "Payment integration", [], {
        taskStatus: "blocked",
        depth: 1,
      }),
    ]),
...
function VisualLanguageSection() {
  return (
    <box flexDirection="column">
      ...
      <text dim>
        Cyan bg is ONLY for selection (cursor, focused, multi-select)
      </text>
      <text> </text>
      <box flexDirection="row">
