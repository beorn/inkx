...
const packages = [
  ...
  { dir: "packages/headless", name: "@silvery/headless" },
  { dir: "packages/commands", name: "@silvery/commands" },
  { dir: "packages/scope", name: "@silvery/scope" },
  { dir: "packages/signals", name: "@silvery/signals" },
  { dir: "packages/model", name: "@silvery/model" },
