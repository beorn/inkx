...
| Scenario | Task Content | Appears On |
|----------|--------------|------------|
| Person | "@bjorn" | @bjorn board |
| Multi-person | "@bjorn @sarah" | @bjorn + @sarah boards |
| Project | "+website +q1" | +website + +q1 boards |
| Tag | "#urgent" | #urgent board |
...
| Scenario | Command/Condition | Result |
|----------|-------------------|--------|
