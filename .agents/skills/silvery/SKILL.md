...
keywords: [silvery, rendering, dirty flags, scroll, visual artifacts]
...
│   └── Possibly a Flexily layout bug → See .agents/skills/flexily/SKILL.md
...
2. **Update docs** — Add to pipeline `AGENTS.md` lessons if new pattern discovered
...
| `src/pipeline/AGENTS.md` | Full pipeline internals reference |
...
- `vendor/silvery/src/pipeline/AGENTS.md` — Dirty flags, cascade, scroll tiers, lessons learned
- `.agents/skills/tui/fix.md` — TUI-level debugging (board driver, diagnostics)
- `.agents/skills/tests/exploratory.md` — Fuzz/exploratory testing workflow
