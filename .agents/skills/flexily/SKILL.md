...
4. **Update docs** — Add to `src/AGENTS.md` lessons if new pattern discovered
...
| `src/AGENTS.md` | Full internals reference with algorithm phases and lessons |
| `tests/relayout-consistency.test.ts` | Re-layout fuzz suite (1200+ tests) |
| `bench/yoga-compare-warmup.bench.ts` | Primary benchmark |

## Cross-References

- `vendor/flexily/src/AGENTS.md` — Algorithm phases, zero-allocation design, caching, lessons learned
...
- `.agents/skills/tui/fix.md` — "Layout Bugs" section for TUI-level diagnosis
