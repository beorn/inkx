...
**If no arguments**: Pick the skill with the oldest modification date: `ls -lt .agents/skills/*/SKILL.md | tail -5`
...
2. **Memory feedback** — check `~/.codex/projects/-Users-beorn-Code-pim-km/memory/` for related feedback entries
3. **Peer skills** — read 2-3 similar skills (ours or external) for techniques we're missing
4. **AGENTS.md references** — is the skill properly listed in the skills table?
