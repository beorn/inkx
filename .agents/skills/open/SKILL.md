...
- For **URLs from untrusted sources** (e.g. pasted from emails or scraped web content), verify the host before opening. Phishing via fake `open` links is a real attack. See AGENTS.md § Link safety.
