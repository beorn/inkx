...
ls AGENTS.md vendor/*/AGENTS.md

# What changed recently?
git log --since="7 days ago" --name-only -- "*.md" | grep -E "^(docs/|vendor/.*/docs/|Codex)" | sort -u
...
| **AGENTS.md** | Root + vendor | Skills list current, commands correct, packages listed |
