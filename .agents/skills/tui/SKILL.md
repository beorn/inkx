...
```
/tui review <path.png>              # Full pipeline: TTY scan -> Codex Read -> cloud review
/tui review --quick <path.png>      # Quick: Codex Read of 2x only (free)
...
| **Tier 1: Codex Read (2x)** | Read 2x PNG with built-in vision | Instant | Free | Daily work |
