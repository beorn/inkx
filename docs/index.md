...
features:
  ...
  - title: Web-like Responsive Layout
    details: '<span class="line"><a href="/guide/hooks">useBoxRectDangerously()</a> — real dimensions during render.</span><span class="line"><a href="/guide/scrolling">Scroll containers</a> — virtualization + <a href="/guide/layout-coordinates">sticky positioning</a>.</span><span class="line"><a href="/guide/ansi-layering">ANSI compositing</a> — color blending with alpha.<a class="feature-link" href="/guide/layouts">Layout guide →</a></span>'
