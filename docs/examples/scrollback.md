...
2. **Layout-first rendering** — components know their width via `useBoxRectDangerously()`, so layout decisions happen correctly on the first paint without a measure-then-rerender cycle
