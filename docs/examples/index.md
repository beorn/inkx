...
| [Tables & Data](/examples/tables)        | Data exploration and filtering  | Table, VirtualList, useBoxRectDangerously() |
...
3. Use `useBoxRectDangerously()` for responsive dimensions
