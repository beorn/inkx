...
// Load terminal glossary — loadTerminalGlossary() uses import.meta.dirname + readFileSync
// which can fail silently in vitepress's Node.js SSR build. Log count to catch silent failures.
      ...
      nav: [
        ...
        { text: "The Silvery Way", link: "/guide/the-silvery-way" },
        {
          ...
          items: [
            ...
            { text: "Islands", link: "/guide/island" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Sterling", link: "/reference/sterling" },
            { text: "Token Taxonomy", link: "/reference/token-taxonomy" },
            { text: "Color Schemes", link: "/reference/color-schemes" },
            { text: "Capability Tiers", link: "/reference/capability-tiers" },
            { text: "Custom Tokens", link: "/reference/custom-tokens" },
            { text: "Style", link: "/reference/style" },
            { text: "Term — the I/O umbrella", link: "/reference/term" },
            { text: "CLS", link: "/reference/cls" },
      ...
      sidebar: [
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: "useHotkey", link: "/api/use-hotkey" },
                { text: "useTextInput", link: "/api/use-text-input" },
                { text: "useInput", link: "/api/use-input" },
                { text: "useRawKeyEvent", link: "/api/use-raw-key-event" },
            ...
            {
              text: "Term sub-owners",
              collapsed: false,
              items: [
                { text: "term.input", link: "/api/term-input" },
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Width Allocation", link: "/guide/width-allocation" },
