...
import { Text, renderToString } from '@silvery/term';
...
echo 'export * from "@silvery/term";' > node_modules/ink/index.js
...
import { render as silveryRender } from '@silvery/term';
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  silvery Compatibility Dashboard                                       v0.1.0  │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
...
import { render } from '@silvery/term';
