...
Provides: `splitNode`, `mergeWithPrevious`, `indentNode`, `outdentNode`. Currently scattered across files -- a TreeOps consolidation is planned (bead `km-core.slate-interfaces`).
