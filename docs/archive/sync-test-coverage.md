...
4. **`diffNodes`** — Node differ lacks direct unit tests
...
8. **Error recovery** — `classifyError`, `calculateBackoffDelay` untested
...
7. **`reconcileDirectoryRecursive`** — Only tested through higher-level sync
