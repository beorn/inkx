...
| Clipboard       | `apps/clipboard.tsx`     | createOsc52Backend, parseClipboardResponse                                                                     | `examples/index.md`                                                                                                 | Working | OSC 52 protocol demo                                                         |
...
| Data Explorer   | `apps/data-explorer.tsx` | VirtualList, TextInput, Divider, useBoxRectDangerously, useDeferredValue                                       | `examples/index.md`, `docs/examples/tables.md`                                                                      | Working | 500+ rows, responsive columns                                                |
| Dev Tools       | `apps/dev-tools.tsx`     | VirtualList, Divider, useBoxRectDangerously                                                                    | `examples/index.md`, web showcase                                                                                   | Working | **Web showcase**: registered. **Screenshot**: `dev-tools.png`                |
| Explorer        | `apps/explorer.tsx`      | VirtualList, TextInput, Tabs, TabList, Tab, Divider, useBoxRectDangerously, useDeferredValue                   | `examples/index.md`                                                                                                 | Working | 2000+ log entries + process table                                            |
| Gallery         | `apps/gallery.tsx`       | Image, Tabs, TabList, Tab, TabPanel, Kbd, useBoxRectDangerously                                                | `examples/index.md`                                                                                                 | Working | Kitty images + paint + truecolor                                             |
...
| Outline         | `apps/outline.tsx`       | outlineStyle vs borderStyle, useBoxRectDangerously                                                             | `examples/index.md`                                                                                                 | Working | Layout comparison demo                                                       |
...
| Virtual 10K     | `apps/virtual-10k.tsx`   | VirtualList, Divider, useBoxRectDangerously, variable itemHeight                                               | `examples/index.md`                                                                                                 | Working | 10,000 item benchmark                                                        |

## Layout Examples (`layout/`)

| Demo        | Path                     | Components                                                                           | Referenced By                                                                                                                                                                               | Status  | Notes                                                                               |
| ----------- | ------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ----------------------------------------------------------------------------------- |
| Dashboard   | `layout/dashboard.tsx`   | Tabs, TabList, Tab, TabPanel, ProgressBar, Table, useBoxRectDangerously, useInterval | `examples/index.md`, web showcase, `docs/examples/layout.md`, `docs/examples/live-demo.md`, `docs/examples/tables.md`, `docs/examples/scrollback.md`, `docs/getting-started/quick-start.md` | Working | **Web showcase**: registered. **Screenshot**: `dashboard.png`. Most-referenced demo |
| Live Resize | `layout/live-resize.tsx` | useBoxRectDangerously, responsive breakpoints                                        | `examples/index.md`                                                                                                                                                                         | Working | **Screenshot**: `layout-feedback.png` (in docs/images/)                             |
