...
| ---------------- | ------- | ----------- | ------------------------------------------------------------- |
| `silvery`        | 0.0.1   | placeholder | All-in-one bundle (re-exports @silvery/react)                 |
| `@silvery/react` | 0.0.1   | placeholder | Core framework                                                |
...
| Package           | What                                           |
| ----------------- | ---------------------------------------------- |
| `@silvery/term`   | Terminal runtime, ANSI output, pipeline        |
| `@silvery/tea`    | TEA state machine store (zustand-based)        |
| `@silvery/ui`     | Component library (30+ components)             |
...
3. **Level 3** (component library): `@silvery/ui`
4. **Level 4** (TEA state machine): `@silvery/tea`
5. **Level 5** (browser target): swap `@silvery/term` for `@silvery/dom`
