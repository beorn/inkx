...
```typescript
import { createCanvasAdapter, renderToCanvas } from '@silvery/term/canvas';
...
```typescript
import { createDOMAdapter, renderToDOM } from '@silvery/term/dom';
...
@silvery/term          (current, production)
