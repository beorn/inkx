...
For raw benchmark numbers, reproduce with `bun run bench`. For the head-to-head Ink comparison with context and code examples, see [Silvery vs Ink](../guide/silvery-vs-ink.md).
