...
describe('Flexx Layout Engine', () => {
	...
	describe('Gap', () => {
		it('should apply gap between row children', () => {
			...
			expect(col1.getComputedLeft()).toBe(0);
			expect(col2.getComputedLeft()).toBeGreaterThan(col1.getComputedLeft() + col1.getComputedWidth());
			expect(col3.getComputedLeft()).toBeGreaterThan(col2.getComputedLeft() + col2.getComputedWidth());
