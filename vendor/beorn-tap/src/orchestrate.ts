 ...
 *
 * - **Parallel mode** (TTY): 3 separate streams with inkx TUI
 ...
 * - `parallel`: Force inkx TUI (requires renderParallel function)
 */
...
export interface OrchestratorOptions {
	...
	output?: Writable
	renderParallel?: (suites: Suite[]) => Promise<number> // Inject inkx renderer
}
