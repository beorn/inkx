...
| 0+ | Module imports | ~500-700ms | Functions with framework imports (zustand, etc.) but no hightea | `input-mode.test.ts` |
...
**Guidelines:**
- Layer 2+ files share the same ~1.8s import cost (React + hightea + layout engine WASM init)
