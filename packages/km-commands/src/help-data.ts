...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    category: "System",
    items: [
      { keys: ["F ⌃g"], command: "filter", description: "filter" },
      { keys: ["S ⌘f"], command: "search_replace", description: "search / replace" },
      { keys: ["D"], command: "toggle_detail_pane", description: "detail pane" },
      { keys: ["C ⌘n"], command: "capture_dialog", description: "capture to inbox" },
      ...
      { keys: ["q"], command: "quit", description: "quit" },
    ],
  },
]
