...
export const textEditingCommands: CommandDef[] = [
  ...
  {
    id: "text.linebreak_split",
    name: "Split at Cursor",
    description: "Split node at cursor position",
    category: "TextEdit",
    execute: (): CommandAction => ({ type: "TEXT_LINEBREAK_SPLIT" }),
  },
  {
    id: "text.linebreak_before",
    name: "Insert Before",
    description: "Insert new node before current",
    category: "TextEdit",
    execute: (): CommandAction => ({ type: "TEXT_LINEBREAK_BEFORE" }),
  },
  {
    id: "text.linebreak_child",
    name: "Insert Child",
    description: "Insert new child node",
    category: "TextEdit",
    execute: (): CommandAction => ({ type: "TEXT_LINEBREAK_CHILD" }),
  },
  {
    id: "text.linebreak_after",
    name: "Insert After",
    description: "Insert new node after current",
    category: "TextEdit",
    execute: (): CommandAction => ({ type: "TEXT_LINEBREAK_AFTER" }),
  },
  {
    id: "text.child_block",
    name: "Insert Child Block",
    description: "Insert new child node (Shift+Enter)",
    category: "TextEdit",
    execute: (): CommandAction => ({ type: "TEXT_CHILD_BLOCK" }),
  },
  {
    id: "text.bold",
    name: "Bold",
