 ...
 *
 * Canonical source for config types, default locations, and file I/O.
 * Consumed by km-tui (startup/save) and internally by favorites.ts
 * (DEFAULT_LOCATIONS used as fallback).
 *
...
/**
 * Default system locations -- the canonical set.
