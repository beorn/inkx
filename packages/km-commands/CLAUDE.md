...
2. [`docs/design/data-model.md`](../../docs/design/data-model.md) and [`docs/design/selection-model.md`](../../docs/design/selection-model.md) — commands operate on `Selection.nodes(ctx)`, never on a single "current node"
