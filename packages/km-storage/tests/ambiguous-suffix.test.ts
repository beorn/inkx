...
describe("ambiguous ID suffix resolution", () => {
  ...
  function createNodesWithSharedSuffix(
    emitter: { emit: (e: Record<string, unknown>) => void },
    suffix: string,
  ): [string, string] {
    ...
    emitter.emit({
      type: "node_created",
      actor: "test",
      data: { id: id1, type: "li", content: "Node 1" },
    })
    emitter.emit({
      type: "node_created",
      actor: "test",
      data: { id: id2, type: "li", content: "Node 2" },
    })
    ...
    test("unique suffix returns the node", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id, type: "li", content: "Unique node" },
        })
    ...
    test("ambiguous prefix returns null", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id1, type: "li", content: "Node A" },
        })
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id2, type: "li", content: "Node B" },
        })
    ...
    test("ambiguous suffix among tasks returns null", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id1, type: "li", content: "Task 1", task_status: "todo", task_marker: "[ ]" },
        })
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id2, type: "li", content: "Task 2", task_status: "todo", task_marker: "[ ]" },
        })
    ...
    test("suffix unique among tasks returns the task", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: taskId, type: "li", content: "Task", task_status: "todo", task_marker: "[ ]" },
        })
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: nonTaskId, type: "li", content: "Not a task" },
        })
    ...
    test("ambiguous ID suffix returns null", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id1, type: "li", content: "Smart node 1" },
        })
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id2, type: "li", content: "Smart node 2" },
        })
    ...
    test("ambiguous ID prefix returns null", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id1, type: "li", content: "Prefix node 1" },
        })
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id: id2, type: "li", content: "Prefix node 2" },
        })
    ...
    test("unique suffix still resolves correctly", () =>
      withTestEnvSync(({ db, emitter }) => {
        ...
        emitter.emit({
          type: "node_created",
          actor: "test",
          data: { id, type: "li", content: "Only one" },
        })
