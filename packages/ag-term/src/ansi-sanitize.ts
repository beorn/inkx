 ...
 * top-level param verbatim — extended-color groups (colon-form) are kept
 * inside their param chunk for downstream consumption.
 */
 ...
 *
 * Returns the parsed color, or `null` when the group is malformed.
 */
