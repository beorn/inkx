...
const repo = {
  database: db,
  path: REPO,
  apply: (e: Parameters<typeof emitter.apply>[0], o?: Parameters<typeof emitter.apply>[1]) => emitter.apply(e, o),
  commit: (e: Parameters<typeof emitter.commit>[0], o?: Parameters<typeof emitter.commit>[1]) => emitter.commit(e, o),
}
