 ...
 *
 * Note: These tests are limited because querySessions opens a SQLite
 * connection to `.km/state.db`. Full integration tests would require
 * setting up a proper test repo with the events table populated.
 */
...
// 2. Inserting session_started and session_ended rows in the events table
