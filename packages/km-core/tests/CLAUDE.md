...
These are the lightest tests in the project (~20-50ms import cost). No database, no framework imports. Keep them pure — if a test here needs `@km/storage` or inkx, it belongs in a higher layer.
