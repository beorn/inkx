---
aliases:
  - @km/infra/test-system.full-app-default-dimensions
  - @km/infra/test-system-full-app-default-dimensions
...
Future: when more full-app helpers (e.g. `createTestApp.fromVault`) gain real-vault paths, mirror this default. Tracked as a sub-bullet in @km/infra/test-system if needed; not opening a separate bead.
