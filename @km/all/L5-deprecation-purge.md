...
parent: "@km/all"
_stub: true
closed_at: 2026-05-07T00:39:36.247Z
closeReason: "All 6 phases shipped: P1 buildRefCondition→links table
  (a71ccd214); P2 stopped writing data.* (b6d22a4b0); P3 DATA_VERSION 3→4
  surgical strip (4c3088a8b); P4 deleted extractMentions/extractProjects
  (da354bebb); P5 6/8 micro-phases shipped + 2 deferred
  (loadRepo→@km/storage/loadRepo-internalize,
  test-helpers→@km/tui/test-helpers-deprecation-cleanup); P6 legacy bd hook
  removed (54aa060f1+5bb2dbd57). Cross-cutting acceptance: 0 data.* in
  production code, 0 in-scope @deprecated, no bd-hook auto-stage, 4137/4137
  in-scope tests pass. Out-of-scope follow-ups: tasks/mutations-plan.ts
  data.tags priority mirror; Asana import data.projects (separate concern).
  Pre-existing tsc errors in vendor/silvery + apps/silvercode are NOT L5
  regressions — separate concurrent-session drift."
---
