...
38. **@km/markdown/heading-task-refs** (P2, from taxes) — closed
- bc2141776 (heading handler reads tags/mentions/props from heading.data)
41. **@km/tui/inline-format-task-with-props** (P2) — closed
- c08133942 (strip props from source slice, preserve bold/link/code)
44. **@km/tui/inline-format-bareurl-underline** (this session) — open
