...
close_reason: Scope absorbed by @km/loggily per scope-consolidation. Open child
  metrics moved → @km/loggily/logger-metrics. logger is the lower-level lib;
  loggily the higher-level interface — kept the family together as one scope.
  Future logging work lives in @km/loggily.
---
