...
mentions:
  - km
id: "@km/silvercode/m5-multi-session-layout"
aliases:
  - km-silvercode.m5-multi-session-layout
  - km-silvercode-m5-multi-session-layout
...
dependencies:
  - issue_id: km-silvercode.m5-multi-session-layout
...
# [x] M5: 2-up multi-session grid + session nav @km/silvercode #task #P2

blocks:: [[@km/silvercode]]

See hub/silvery/future/ai-terminal/00-agent-workspace.md Phased delivery section for M5- scope.
