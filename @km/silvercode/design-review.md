...
close_reason: |-
  ...
  - km-silvercode.notification-row-color-hierarchy (P3)
...
Mouse-wheel to scroll. NotificationEventRow rows are click-to-expand.
...
- **ToolCall** — header (✗/⚙/spinner glyph + title), block border, expand chevron
...
- **NotificationEventRow** — per-source presentation
...
- **StructuredQuestion / StructuredAnswer** — mid-turn question block
...
- NotificationEventRow per-source iconography + color coding
