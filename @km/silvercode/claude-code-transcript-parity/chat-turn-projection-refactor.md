...
- Notifications and session metadata are session entries. They may visually appear between turns, but should not become turn-owned data.
...
- [ ] Notifications and session metadata stay session-level and render in the prose lane.
